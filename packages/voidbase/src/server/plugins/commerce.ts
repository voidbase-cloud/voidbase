// `@voidbase-cloud/voidbase/plugins/commerce`, a re-export of `@voidbase-cloud/plugin-commerce` since 3.7.
//
...
//
// `export *` and not a list: `commerceInfo`, `commerceWith` and the collection names are this module's published
// surface, and the unit suites import them through this path.
