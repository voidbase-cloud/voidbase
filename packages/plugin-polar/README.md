# @voidbase-cloud/plugin-polar

The polar plugin of [voidbase](https://github.com/voidbase-cloud/voidbase), as a package of its own. Taking money through Polar: provides payments@1 with Polar's REST API, its Standard Webhooks and the shared payment rows.
...
- **`@voidbase-cloud/voidbase/plugins/polar` stays published**, as a re-export of this package.
