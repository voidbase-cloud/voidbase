...
//
// The file is the one that sat in `packages/voidbase/src/server/plugins/tax-flat.ts`, with its five relative
// imports written as the five published names they already resolved to: `#platform/env` is package-private and
...
export const taxFlatInfo = (env) => ({ rate: taxRate(env) });
