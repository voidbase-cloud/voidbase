...
## [0.9.0-beta.57](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.56...v0.9.0-beta.57) (2026-09-12)

* refactor(plugin,seo): seo in a package of its own, and the two halves of it the core keeps

## [0.9.0-beta.56](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.55...v0.9.0-beta.56) (2026-09-12)

* fix(ci): publish the workspace in waves, so a release with nine new names fits in the build

## [0.9.0-beta.55](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.54...v0.9.0-beta.55) (2026-09-12)

* fix(realtime): a bare collection topic subscribes to the collection, as it does in PocketBase

## [0.9.0-beta.54](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.53...v0.9.0-beta.54) (2026-09-12)

* fix(ci): wait for a published package to be resolvable before publishing what names it
...
## [0.9.0-beta.51](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.50...v0.9.0-beta.51) (2026-09-12)

* refactor(ci): make the repository a workspace, the package in packages/voidbase
...
## [0.9.0-beta.47](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.46...v0.9.0-beta.47) (2026-09-11)

* fix(commerce): a payment moves an order only when it pays that order for what it bought

## [0.9.0-beta.46](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.45...v0.9.0-beta.46) (2026-09-11)

* fix(server): imports keep runtime system fields; installs need a trusted marketplace

## [0.9.0-beta.45](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.44...v0.9.0-beta.45) (2026-09-11)

* fix(plugin): /api/plugins answers no ai conversations without a database, not from another's cache
...
## [0.9.0-beta.37](https://github.com/voidbase-cloud/voidbase/compare/v0.9.0-beta.36...v0.9.0-beta.37) (2026-09-11)

* feat(plugin): observability, the second core plugin
