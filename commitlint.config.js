...
export default {
  ...
  rules: {
    ...
    "scope-enum": [1, "always", ["server", "records", "collections", "auth", "oauth2", "realtime", "hub", "jobs", "mail", "files", "hooks", "migrations", "settings", "logs", "crons", "backups", "hardening", "deploy", "cloud", "bundle", "cli", "serve", "plugin", "panel", "docs", "ci", "release", "deps", "test", "site", "starter"]],
