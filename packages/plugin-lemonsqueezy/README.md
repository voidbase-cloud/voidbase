# @voidbase-cloud/plugin-lemonsqueezy

The lemonsqueezy plugin of [voidbase](https://github.com/voidbase-cloud/voidbase), as a package of its own. Taking money through Lemon Squeezy: provides payments@1 with its JSON:API, its signed webhooks and the shared payment rows.
...
- **`@voidbase-cloud/voidbase/plugins/lemonsqueezy` stays published**, as a re-export of this package.
