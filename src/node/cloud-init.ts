...
export function writeCloudProject(out: string, mode: "package" | "internal" = "package", extra: { hooksDir?: string; migrationsDir?: string; pluginsDir?: string; entry?: string; queue?: string | false; hub?: boolean; workflows?: { file: string; className: string }[] } = {}): { files: number; out: string } {
