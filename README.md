...
- [docs/platform.md](docs/platform.md): how to run cheap and fast on Cloudflare (assets off the Worker, log writes, change feed, crons, placement) and the per-app Durable Object design for going beyond the account limits.
